...
namespace MvcBlogSitesi.Controllers
{
    public class AdminKategoriController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KategoriNo,KategoriAdı")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KategoriNo,KategoriAdı")] Kategori kategori)
        {
            if (ModelState.IsValid)
            {
